	...
	public ResponseEntity<String> oauth2Callback(@RequestParam(value = "code") String code) {
		...
		try {
			...
			for (Event event : items) {  
			    System.out.println("Events Sum"+event.getSummary());
			  }
			// Retrieve a specific calendar list entry
			CalendarListEntry calendarListEntry = client.calendarList().get("thiruvasagam@ation.co").execute();

			System.out.println("calendarListEntry"+calendarListEntry.getLocation());
		} catch (Exception e) {
